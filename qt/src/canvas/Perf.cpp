...
void Perf::report() {
    ...
    std::fprintf(stderr,
                 ...
                 "sync %.2f/%.2f ms | tiles %lld previews %lld | geometry %lld (displays %lld) | sharp %lld after "
                 "%.0f/%.0f ms\n",
                 ...
                 static_cast<long long>(values[GeometryPictures]), static_cast<long long>(values[GeometryDisplays]),
