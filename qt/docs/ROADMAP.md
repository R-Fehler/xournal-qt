...
- **Next:** image insert; then PDF links and text highlighting, PDF export (selection, shapes, text, image), PDF links and text highlighting, PDF export and search; MuPDF on the `mupdf` branch.
