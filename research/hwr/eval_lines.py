...
sets = {
    "IAM-val (en)": glob.glob('/home/fehler/.cache/huggingface/hub/datasets--Teklia--IAM-line/snapshots/*/data/validation.parquet')[0],
    "fhswf German": glob.glob('/home/fehler/.cache/huggingface/hub/datasets--fhswf--german_handwriting/snapshots/*/data/train-00001-of-00008.parquet')[0],
}
for mname in models:
